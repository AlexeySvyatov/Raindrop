...
public class GameScreen implements Screen {
    ...
    public GameScreen(final MyGdxGame fallout) {
        this.game = fallout;
        background = new Texture("pictures/mojave.png");
        playerImage = new Texture(Gdx.files.internal("pictures/courier.png"));
        dropImage = new Texture(Gdx.files.internal("pictures/sarsaparilla.png"));
        music = Gdx.audio.newMusic(Gdx.files.internal("sounds/bigIron.mp3"));
    ...
    public void render(float delta) {
        ...
        game.font.draw(game.batch, "Me collected: " + sarsCollected, 0, 470);
        ...
        if (finishTime - startTime > 65000){
            raindrops.clear();
            music.stop();
            game.setScreen(new EndGameScreen(game, sarsCollected));
        }
    }
    @Override
    public void dispose(){
